...
import br.com.alura.leilao.formatter.FormataParaReal;
...
public class LancesLeilaoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(dadosRecebidos.hasExtra("leilao")){
            ...
            FormataParaReal formataParaReal = new FormataParaReal();
            ...
            maiorLance.setText(formataParaReal.formata(leilao.getMaiorLance()));
            TextView menorLance = findViewById(R.id.lances_leilao_menor_lance);
            menorLance.setText(formataParaReal.formata(leilao.getMenorLance()));
