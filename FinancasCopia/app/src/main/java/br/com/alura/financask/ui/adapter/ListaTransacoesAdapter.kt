...
class ListaTransacoesAdapter(private val transacoes : List<Transacao>,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val viewCriada = LayoutInflater.from(context)
                .inflate(R.layout.transacao_item, parent,
                false)
    ...
    private fun adicionaData(transacao: Transacao, viewCriada: View){
        viewCriada.transacao_data.text =
                transacao.data.formataParaBrasileiro()
    }

    private fun adicionaCategoria(transacao: Transacao, viewCriada: View){
        viewCriada.transacao_categoria.text =
                transacao.categoria.limitaEmAte(limiteDaCategoria)
    }
    ...
    private fun adicionaValor(transacao : Transacao, viewCriada : View){
        ...
        viewCriada.transacao_valor.text =
                transacao.valor.formataParaBrasileiro()
    }
